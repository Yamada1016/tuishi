...
# AiPro2022フォルダに移動して…
#
# > py  -3.9  -m  venv  .tuishi     ← 新しい仮想環境「.tuishi」を生成する
#
# > .tuishi\Scripts\activate.bat    ← 新しい仮想環境「.tuishi」を起動する
#
# (.tuishi) > python -m pip install -r requirements.txt   ← ライブラリの一括インストール
#
...
#
#
# (.tuishi) > streamlit run stapp_retire.py    ← Webアプリ（stapp_retire.py）を起動


""" Streamlitによる退職予測AIシステムの開発(追試用)
"""
...
def main():
    ...
    # サイドメニューの設定
    activities = ["データ確認", "要約統計量", "グラフ表示", "学習と検証"]
